...
public class FareCalculatorServiceTest {
	...
	public void calculateFareCarWithReduction() {
		Date inTime = new Date();
		inTime.setTime(System.currentTimeMillis() - (100 * 60 * 1000));
		Date outTime = new Date();
		ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
		...
		assertEquals(100 * Fare.CAR_RATE_PER_HOUR / 60 * Fare.REDUCTION, ticket.getPrice());
	}
	...
	public void calculateFareBikeWithReduction() {
		...
		assertEquals(100 * Fare.BIKE_RATE_PER_HOUR / 60 * Fare.REDUCTION, ticket.getPrice());
	}
